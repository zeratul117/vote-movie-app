...
export default function Header() {
  return (
    <header className="w-full textColor flex items-center justify-between p-6 lg:px-8 bg-[#030f46] rounded-md" aria-label="Global">
      <Link href="/" className="text-xl font-bold">
        <FilmIcon />
      </Link>
      <Link href="/" className="text-xl font-bold">
        <div className="flex items-center">
          <h2 className="text-sm md:text-lg font-bold">Add and Vote for movies!</h2>
        </div>
      </Link>
